...
/**
 * Generate the search trigger button HTML for the header.
 * Opens a search modal on click (replaces old inline search bar).
 */
function generateSearchHTML() {
  return `      <button id="search-modal-trigger" class="search-trigger-btn" aria-label="Suche oeffnen (Ctrl+K)" title="Suche (Ctrl+K)">
